...
const testimonials = [
  ...
  },
  {
    ...
    imagePosition: "50% 42%",
    prompt: "",
    quote: "原本是工程師，已有三年的身體覺察與練習經驗，希望離開朝九晚五，發展一份能自主安排時間、也更貼近興趣的工作。過去雖接觸過筋膜理論，但跟方寊老師學習後，才真正建立起完整的按摩流程，也理解按摩不只是手怎麼做，更要運用重心轉換，讓力量從身體流動到手上。老師會依每個人的身體和習慣調整手法；如今實際服務客人時，也能依不同的身體狀況靈活調整，不再只能照著固定流程操作。",
